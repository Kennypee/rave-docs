...
import CreateAReactApplication from './parts/2.create-a-react-application.md'
...
const Component = () => (
	<React.Fragment>
		...
		<div className={contentStyle.markdown} id="create-a-react-application"><CreateAReactApplication /></div>
