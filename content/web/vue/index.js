...
import CreateAVueApplication from './parts/2.create-a-vue-application.md'
...
const Component = () => (
	<React.Fragment>
		...
		<div className={contentStyle.markdown} id="create-a-vue-application"><CreateAVueApplication /></div>
